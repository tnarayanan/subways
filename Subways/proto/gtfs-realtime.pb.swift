...
/// NOTE: This message is still experimental, and subject to change. It may be formally adopted in the future.
struct TransitRealtime_Stop: SwiftProtobuf.ExtensibleMessage {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  enum WheelchairBoarding: SwiftProtobuf.Enum {
    typealias RawValue = Int
    case unknown // = 0
    case available // = 1
    case notAvailable // = 2
...
extension TransitRealtime_Stop.WheelchairBoarding: CaseIterable {
  // Support synthesized by the compiler.
}
...
/// NOTE: This field is still experimental, and subject to change. It may be formally adopted in the future.
struct TransitRealtime_TripModifications: SwiftProtobuf.ExtensibleMessage {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  struct Modification: SwiftProtobuf.ExtensibleMessage {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  struct SelectedTrips: SwiftProtobuf.ExtensibleMessage {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
struct TransitRealtime_StopSelector: SwiftProtobuf.ExtensibleMessage {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// NOTE: This field is still experimental, and subject to change. It may be formally adopted in the future.
struct TransitRealtime_ReplacementStop: SwiftProtobuf.ExtensibleMessage {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension TransitRealtime_TripDescriptor.ModifiedTripSelector: @unchecked Sendable {}
...
extension TransitRealtime_Stop: @unchecked Sendable {}
extension TransitRealtime_Stop.WheelchairBoarding: @unchecked Sendable {}
extension TransitRealtime_TripModifications: @unchecked Sendable {}
extension TransitRealtime_TripModifications.Modification: @unchecked Sendable {}
extension TransitRealtime_TripModifications.SelectedTrips: @unchecked Sendable {}
extension TransitRealtime_StopSelector: @unchecked Sendable {}
extension TransitRealtime_ReplacementStop: @unchecked Sendable {}
